...
<![CDATA[
	...
	function update_text(e) {
		...
		var charts = parseInt(w/($fontsize * $fontwidth))
...
$im->stringTTF("unzoom", $xpad, $fontsize * 2, "取消放大", 'class="hide"');
$im->stringTTF("search", $imagewidth - $xpad - 120, $fontsize * 2, "搜索");
$im->stringTTF("ignorecase", $imagewidth - $xpad - 60, $fontsize * 2, "忽略大小写");
